...
function createApolloClient(
  ...
  return new ApolloClient({
    ...
    link: createLink(accessToken, refreshToken),
    cache: new InMemoryCache(),
    connectToDevTools: true,
  });
}

function createHttpLink(accessToken?: string, refreshToken?: string): HttpLink {
  return new HttpLink({
...
export function createLink(
  ...
  return ApolloLink.from([
    apolloLogger,
    createErrorLink(),
    createHttpLink(accessToken, refreshToken),
  ]);
}
...
export function initializeApollo(
  ...
  const _apolloClient =
    apolloClient ?? createApolloClient(accessToken, refreshToken);
